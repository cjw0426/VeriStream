...
def main() -> None:
    parser = argparse.ArgumentParser(description="OVO-Bench recent-window evaluation for Qwen2.5-VL")
    parser.add_argument("--model_path", required=True, help="Example: Qwen/Qwen2.5-VL-7B-Instruct")
    ...
    parser.add_argument("--result_dir", default="results/ovo_bench_recent_window_qwen25vl")
    ...
    if accelerator.is_main_process:
        ...
        output_path = os.path.join(args.result_dir, f"qwen25vl_results_{timestamp}.json")
